...
module.exports = defineConfig({
  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        ...
        // Props are seldom mutated anyway:
    ...
    },
    {
      ...
      rules: {
        ...
        'jsdoc/check-examples': off,
        'jsdoc/check-indentation': [off, { excludeTags: ['example'] }],
  ...
  rules: {
    ...
    // Replaced by `unicorn/no-negated-condition`:
    ...
    'no-restricted-globals': [
      ...
      'isNaN',
      /*
       * https://github.com/sidoshi/eslint-restricted-globals/blob/master/index.js
       */
      'addEventListener',
      'blur',
      'close',
